			...
			<div class="container">
				<div class="panel panel-default top-buffer">
					<div class="panel-body form-group">
						<div class="row">
							<div class="col-md-offset-2 col-md-8 h3 text-center">Group
				...
				<div class="panel panel-default top-buffer">
					<div class="panel-body ">
						<div class="row">
							...
							<div class="col-sm-2">
								<button type="button" class="btn btn-link btn-sm addGroup">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Add Student(s) to Group</h4>
					</div>
					<!-- End modal-header -->
