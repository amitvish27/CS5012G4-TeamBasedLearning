...
/**
 * Servlet implementation class ListUserLnameServlet
 */
@WebServlet("/ListUserLname")
public class ListUserLnameServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//TODO in the view add stuff for deleted and other 
